...
class	BaseScene
{
	...
	function	OnSetup(scene)
	{
		...
		if (save_to_video)
		{
			...
			filename_base = "frame"
			save_frame_idx = 0
			SceneSetFixedDeltaFrame(scene, 1.0 / 50.0)
	...
	*/
	function	SaveCurrentFrameToTGA()
	{
		...
		PictureSaveTGA(save_picture, "video/" + filename_base + "_" + frame_idx + ".tga")
		save_frame_idx++
	}
